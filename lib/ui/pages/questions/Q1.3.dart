import 'dart:async';
import 'dart:io';
import 'package:connections_inc/ui/pages/questions/Q1.4.dart';
...
bool isSelected2 = false;
  ...
  Widget build(BuildContext context) {
    ...
    String ques = "If your worst fear actually came to life, what would you do?";
    String ans1 = "1.	You’ll handle it as you try to handle every other thing; you don’t give up easily";
    String ans2 = "2.	You’ll feel set back, it won’t be something that you can take care of easily";
    return SafeArea(
      child: Scaffold(
        body: Stack(
          children: <Widget>[
...
//                          color: Colors.amber
                  ...
                  Column(
                    children:[
                      Container(
                        //margin: EdgeInsets.all(7.0),
                        padding: EdgeInsets.fromLTRB(size.width*20.0/360.0, size.height*155.0/780.0, size.width*20.0/780.0, 0.0),
                        child: Text(
                          ques,
                          style: TextStyle(
                            fontFamily: 'Montserrat',
...
//                     color: Colors.amber
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          //margin: EdgeInsets.all(7.0),
                          margin: EdgeInsets.fromLTRB(size.width*20.0/360.0, .0, 15, 0.0),
