import 'dart:async';
import 'dart:io';
import 'package:connections_inc/ui/pages/partner/partner1.dart';
...
class _Design5State extends State<Design5> with TickerProviderStateMixin{
  String fname,lname,gender,interest,personality;
  DateTime age;
  File avatar;
  ...
  Widget build(BuildContext context) {
    ...
    String ques = "How do you feel when all the eyes around you are on you?";
    String ans1 = "1.  I feel good, as I don’t mind all the attention being centered on me.";
    String ans2 = "2.  I feel intimidated and in a position in which I’m not very comfortable.";
    String ans3 = "3.  Depends. If I’m with my family & friends, it’s fine, but with strangers? NO ";
                      ...
                      GestureDetector(
                        onTap: (){
                          setState(() {
                            flag1 = 0;
                            flag2 = 1;
                            flag3 = 0;isSelected2 = !isSelected2;
                            isSelected = false;
                            isSelected3 = false;
                      ...
                      GestureDetector(
                        onTap: (){
                          setState(() {
                            flag1 = 0;
                            flag2 = 0;
                            flag3 = 1;isSelected2 = false;
                            isSelected3 = !isSelected3;
                            isSelected = false;
                            height = isSelected3?size.height*728/780.0:size.height*.8;
                            //temp = size.height*.8;
                            width = isSelected3?size.width:size.width*.8;
...
//                    color: Colors.amber
            ...
            GestureDetector(
                onTap: (){
                  ...
                  personality = intro<extro ? "E":"I";
                  personality += uptight<easy ? "E":"U";
                  personality += practical<emotional? "E":"P";
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => Partner1(
                    avatar: avatar,fname: fname,lname: lname,age: age,gender: gender,interest: interest,personality: personality,)));
                }
                },
                child: Container(

                  margin: EdgeInsets.fromLTRB(size.width*20.0/360.0,size.height*635.0/780.0
