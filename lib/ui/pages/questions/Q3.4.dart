import 'dart:async';
import 'dart:io';
import 'package:connections_inc/ui/pages/questions/Q3.5.dart';
...
class Design4 extends StatefulWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String ques = "At your workplace, there’s a rumour going on about you. You hear it from somebody, what is your gut reaction?";
    String ans1 = "1.  You lose your shit and directly confront the person who has been spreading it.";
    String ans2 = "2.  You don’t bother to think about it even for another second, too trivial to think about.";
            ...
            Container(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Container(
                    //margin: EdgeInsets.all(7.0),
                    padding: EdgeInsets.fromLTRB(size.width*93.0/360.0,
