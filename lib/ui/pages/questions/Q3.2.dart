import 'dart:async';
import 'dart:io';
import 'package:connections_inc/ui/pages/questions/Q3.3.dart';
...
class _Design2State extends State<Design2> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    String ques = "Do you always struggle to find your keys?";
    String ans1 = "1.  Nah, I have designated spots for things such as keys.";
    String ans2 = "2.  Yes, I struggle to find them all the time.";
