import 'dart:async';
import 'dart:io';
import 'package:connections_inc/ui/pages/questions/Q3.1.dart';
...
class _Design5State extends State<Design5> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    String ques = "Your Favourite Celebrity comes to your college as a chief guest for an event. At "
        "the event’s Q&A round, you have a question that you want to ask them, what do you do?";
    String ans1 = "1.  You cannot muster the strength to step up and ask the question, and hence let it Pass";
    String ans2 = "2.  You step up and ask your question without thinking twice.";
