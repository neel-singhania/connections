...
import 'package:connections_inc/bloc/messaging/bloc.dart';
import 'package:connections_inc/bloc/messaging/messaging_bloc.dart';
import 'package:connections_inc/models/message.dart';
import 'package:connections_inc/models/user.dart';
import 'package:connections_inc/repository/messaging.dart';
//import 'package:chill/ui/constants.dart';
import 'package:connections_inc/ui/widgets/message.dart';
import 'package:connections_inc/ui/widgets/photo.dart';
    ...
    _messagingBloc.add(
      SendMessageEvent(
        message: Message(
          ...
          senderName: widget.currentUser.fname,
          ...
          children: <Widget>[
            ClipOval(
              child: Container(
                ...
                child: PhotoWidget(
                  photoLink: widget.selectedUser.avatar,
                ),
              ),
            ),
            SizedBox(
            ...
            Expanded(
              child: Text(widget.selectedUser.fname),
            ),
          ],
        ),
      ),
