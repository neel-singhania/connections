import 'package:connections_inc/bloc/search/bloc.dart';
import 'package:connections_inc/models/user.dart';
import 'package:connections_inc/repository/searchRepository.dart';
...
//                            Colors.yellow),
                        ...
                        iconWidget(FontAwesomeIcons.solidHeart, () {
                          _searchBloc.add(
                            SelectUserEvent(
                                name: _currentUser.fname,
                                photoUrl: _currentUser.avatar,
