...
import 'package:connections_inc/ui/pages/partner/partner2.dart';
...
class Partner1 extends StatefulWidget {
  ...
  Partner1({Key key,@required this.fname,@required this.lname,@required this.age, @required this.gender, @required this.interest,@required this.avatar, @required this.personality}):super(key:key);
  @override
  _Partner1State createState() => _Partner1State(avatar,fname,lname,age,gender,interest,personality);
}

class _Partner1State extends State<Partner1> {
  String fname,lname,gender,interest,personality,partner;
  File avatar;
  DateTime age;
  _Partner1State(this.avatar,this.fname,this.lname,this.age,this.gender,this.interest,this.personality);
  int selected;
...
//                  color: ,
              ...
              GestureDetector(
                  onTap: (){
                    ...
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Partner2(
                        avatar: avatar,fname: fname,lname: lname,age: age,gender: gender,interest: interest,personality: personality, partner: partner)));
                  },
                  child: Container(
