...
import 'package:connections_inc/ui/pages/partner/partner3.dart';
import 'package:flutter/material.dart';

class Partner2 extends StatefulWidget {
  String fname,lname,gender,interest,personality,partner;
  File avatar;
  DateTime age;

  Partner2({Key key,@required this.fname,@required this.lname,@required this.age, @required this.gender,
    @required this.interest,@required this.avatar, @required this.personality,@required this.partner}):super(key:key);
  @override
  _Partner2State createState() => _Partner2State(avatar,fname,lname,age,gender,interest,personality,partner);
}

class _Partner2State extends State<Partner2> {
  String fname,lname,gender,interest,personality,partner;
  File avatar;
  DateTime age;
  _Partner2State(this.avatar,this.fname,this.lname,this.age,this.gender,this.interest,this.personality,this.partner);
  int selected;
...
//                  color: ,
              ...
              GestureDetector(
                  onTap: (){
                    ...
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Partner3(
